...
class EditRekap extends Component
{
    ...
    public function saveRekap()
    {
        $this->validate([
            ...
            'dataRekap.wisatawan_nusantara.gte' => 'Jumlah wisatawan nusantara tidak boleh kurang dari 0',
            'dataRekap.wisatawan_mancanegara.required' => 'Jumlah wisatawan mancanegara tidak boleh kosong',
            'dataRekap.wisatawan_mancanegara.gte' => 'Jumlah wisatawan mancanegara tidak boleh kurang dari 0',
